...
from scoring.main import get_score
...
if __name__ == "__main__":
    ...
    for idx, mask in enumerate(masks):
        ...
        # scoring
        score = get_score(img_filled_p)
        print(f"{img_filled_p}: {score}")

        if score > best_score:
            best_score = score
            save_array_to_img(img_filled, str(out_dir / "best.png"))
            print(f'new best: {img_filled_p} with score {score}.')
